...
require_once dirname(dirname(__FILE__)) . '/classes/subscribemeads.class.php';
...
$modx->regClientStartupScript($sm->config['js_url'].'mgr/subscribemeads.class.js');
...
return '<div id="subscribemeads"></div>';
?>