...
if ($changed) {
    ...
    $chunk = $modx->getOption('subscribemeads.email.passwordchanged',null,'smPasswordChangedEmail');
    $subject = $modx->getOption('subscribemeads.email.passwordchanged.subject',null,'Your Password was Changed');
